...
public class CreatePostServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //if (isMultipart) {
               ...
               /* FileItem picture = items.get(2);
                ...
                uploadedFile = new File("C:\\Amit\\Software\\workspace\\Social\\WebContent\\person.gif");
                }
                
               uploadedFile = new File(pictureFilename);
		...
		if(!personId.equals(ownerId) && !friendRequestDao.areFriends(personId, ownerId)) {
            ...
            if(postDao.createPost(title, text, personId, ownerId, youtubeVideoId, link)) {
