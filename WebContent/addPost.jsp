    ...
    <form action="create_post" method="post" enctype="multipart/form-data">
      <table cellspacing="2" cellpadding="0" border="0">
        <tbody>
          ...
          <tr>
            <!-- <td>Upload Photo:</td> -->
            <td><input type="hidden" name="photo" size="25" /></td>
          </tr>
          <tr>
            <!-- <td>Add Youtube Video ID:</td> -->
            <td><input type="hidden" name="video" size="25" /></td>
          </tr>
          <tr>
            <td>Complete Product Link:</td>
            <td><input type="text" name="link" size="256" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>
