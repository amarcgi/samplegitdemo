					...
					<div class="product-details"><!--product-details-->
						...
						<form action="addCart.jsp">
							<div class="product-information"><!--/product-information-->
								...
								<p>Web ID: <%= request.getParameter("sku")%></p>
								<input type="hidden" name="sku" value="<%= request.getParameter("sku")%>">
								<span>
									<span>salesPrice: US <%= request.getParameter("salesPrice")%></span>
									<span>regularPrice: US <%= request.getParameter("regularPrice")%></span>
								...
								<p>
											  <b> Global Rating:</b><%= request.getParameter("customerReviewAverage")%>
...
<%  
	...
	try{
		...
		String sql1="select AVG(rating) from product where sku='"+sku+"' ";
...
<%  
	...
	try{
		...
		String sql2="select AVG(rating) from product where  sku='"+sku+"'  and  rating_by in( SELECT rating_by FROM product where buyer_status='1')";
...
%>
					...
					<p>
											  <b> EShopper Buyer's Rating:</b><%= rating2%>
...
%>						
	...
	try{
		...
		String sql3="select AVG(rating) from product where  sku='"+sku+"' and  rating_by in(SELECT id FROM people p WHERE EXISTS (SELECT * FROM friendRequests f WHERE ((f.sourceId='"+personId+"' AND f.targetId=p.id) OR (f.sourceId=p.id AND f.targetId='"+personId+"')) AND f.status='ACCEPTED'))";
...
%>
					...
					<p>
											  <b> EShopper Friend's Rating:</b><%= rating3%>
					...
					<div class="category-tab shop-details-tab">category-tab
						...
						<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="ratingInsert.jsp">
									<input type="hidden" name="sku" value="<%= request.getParameter("sku")%>">
									
										<b>Rating: </b> 
										<input type="radio" name="rating" value="1" checked> 1
										<input type="radio" name="rating" value="2" checked> 2
										...
										<button type="submit" class="btn btn-default pull-right" value="submit"  name="submit">Submit</button>
